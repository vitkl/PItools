...
readQSLIMFinderMain = function(outputfile = "forSLIMFinder_file_list$outputfile"){
...
readQSLIMFinderOccurence = function(outputdir = "forSLIMFinder_file_list$outputdir"){
